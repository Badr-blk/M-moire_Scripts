...
vlue_comp = pd.read_csv('MTUM_holdings.csv', skiprows=9)
...
# Sauvegarder
vlue_liquid.to_csv('MTUM_liquid_filtered.csv', index=False)
print("\n✅ Fichier MTUM_liquid_filtered.csv créé avec succès !")
