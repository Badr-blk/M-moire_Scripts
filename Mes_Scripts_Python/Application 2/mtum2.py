...
mtum_liquid = pd.read_csv('MTUM_liquid_filtered.csv')
tickers = mtum_liquid['Ticker'].tolist()
...
benchmark = yf.download('MTUM', start='2019-01-01', end='2024-12-31', auto_adjust=True)
...
for year in years:
    ...
    filtered_weights = mtum_liquid[mtum_liquid['Ticker'].isin(filtered_tickers)].set_index('Ticker')['New Weight']
...
print("\n✅ Résultats de performance MTUM filtré :")
print(filtered_performance_df)
filtered_performance_df.to_csv('Analyse_MTUM_Filtré_2019_2024.csv')
print("\n✅ Fichier 'Analyse_MTUM_Filtré_2019_2024.csv' sauvegardé !")
