...
usmv_liquid = pd.read_csv('USMV_liquid_filtered.csv')
tickers = usmv_liquid['Ticker'].tolist()
...
benchmark = yf.download('USMV', start='2019-01-01', end='2024-12-31', auto_adjust=True)
...
for year in years:
    ...
    filtered_weights = usmv_liquid[usmv_liquid['Ticker'].isin(filtered_tickers)].set_index('Ticker')['New Weight']
...
print("\n✅ Résultats de performance USMV filtré :")
print(filtered_performance_df)
filtered_performance_df.to_csv('Analyse_USMV_Filtré_2019_2024.csv')
print("\n✅ Fichier 'Analyse_USMV_Filtré_2019_2024.csv' sauvegardé !")
