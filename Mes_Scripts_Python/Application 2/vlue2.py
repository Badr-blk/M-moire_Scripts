...
vlue_liquid = pd.read_csv('VLUE_liquid_filtered.csv')
tickers = vlue_liquid['Ticker'].tolist()
...
benchmark = yf.download('VLUE', start='2019-01-01', end='2024-12-31', auto_adjust=True)
...
for year in years:
    ...
    filtered_weights = vlue_liquid[vlue_liquid['Ticker'].isin(filtered_tickers)].set_index('Ticker')['New Weight']
...
print("\n✅ Résultats de performance VLUE filtré :")
print(filtered_performance_df)
filtered_performance_df.to_csv('Analyse_VLUE_Filtré_2019_2024.csv')
print("\n✅ Fichier 'Analyse_VLUE_Filtré_2019_2024.csv' sauvegardé !")
